...
# Target Parameters
pellet_size = st.slider("Pellet Size (mm)", 0.3, 20.0, 5.0, step=0.1)
bulk_density = st.slider("Bulk Density (g/l)", 300, 750, 500)
final_fat = st.slider("Final Fat (%)", 7, 44, 10)
dry_meal_throughput = st.slider("Dry Meal Throughput (tonne/h)", 0.4, 30.0, 10.0, step=0.1)
